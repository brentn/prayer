...
@Component({
    standalone: true,
    imports: [CommonModule, MatListModule, MatCheckboxModule, MatIconModule, MatButtonModule, MatDividerModule, MatSnackBarModule],
...
export class SettingsComponent {
    ...
    async cleanupData() {
        ...
        try {
            ...
            this.snackBar.open('An error occurred during cleanup.', 'OK', { duration: 3000 });
        } finally {
