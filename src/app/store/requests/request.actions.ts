...
export const updateRequest = createAction('[Requests] Update', props<{ id: number; changes: { description?: string; archived?: boolean; createdDate?: string; answeredDate?: string | null; answerDescription?: string; prayerCount?: number; priority?: number } }>());
