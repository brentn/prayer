...
export const updateRequest = createAction('[Requests] Update', props<{ id: number; changes: { description?: string; createdDate?: string; answeredDate?: string | null; answerDescription?: string; prayerCount?: number; priority?: number } }>());
